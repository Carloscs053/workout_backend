...
const leerInput = async( message ) => {
    ...
    //devuelve un objeto pero nos interesa solo la descripcion => desestructuramos la descripcion
...
const listadoTareasBorrar = async( tareas = [] ) => {
    ...
    //nueva opción para añadir al inicio la opción de cancelar el borrado...
    choices.unshift({
        value: '0',
        name: '0.'.green + ' Cancelar'
    });

    const preguntas = [//consultar la documentación de inquirer...
        {
            type: 'list',
            name: 'id',
            message: 'Borrar',
